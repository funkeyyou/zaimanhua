...
import 'package:zai_x/modules/user/history/comic/comic_history_controller.dart';
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  AppStyle.vGap4,
                  Text("看到${item.chapterName} ${item.record}頁",
                      style: const TextStyle(color: Colors.grey, fontSize: 14)),
                  AppStyle.vGap4,
                  Text("觀看於${Utils.formatTimestamp(item.viewingTime ?? 0)}",
                      style: const TextStyle(color: Colors.grey, fontSize: 14)),
                ],
              ),
            ),
