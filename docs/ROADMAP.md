...
- 未發佈（2026-09-09）：漫畫書架未讀更新／已追平、按帳號隔離的完整書架快取與穩定刷新、每部漫畫獨立閱讀設定、封面與離線圖片記憶體優化、停止隱藏動畫。72 個測試與 Android／Windows CI 建置通過；MuMu 核心流程已驗證，Windows 介面、繁體畫面與實體折疊機待驗收。見 [驗證紀錄](QA-2026-09-09.md)
