...
[最新版 v1.9.0](../../releases/latest) 提供安卓 APK 與 Windows 免安裝壓縮檔。App 內「我的 → 檢查更新」讀的也是同一處。

v1.9.0 新增未讀更新／已追平篩選、離線書架快取與每部漫畫獨立閱讀設定，並改善封面記憶體與隱藏動畫耗用。詳細驗證範圍見 [驗證紀錄](docs/QA-2026-09-09.md)。
...
圖示來源及重建方式見 [品牌素材](assets/brand/README.md)，驗證結果見 [UI 驗證紀錄](docs/QA-2026-09-09-UI.md)。目前正式版 v1.9.0 仍使用原名稱及圖示。
