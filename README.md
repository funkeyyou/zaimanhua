...
[最新版 v2.1.0](../../releases/latest) 提供安卓 APK 與 Windows 免安裝壓縮檔。App 內「我的 → 檢查更新」讀的也是同一處。

v2.1.0 更新關於頁作者資訊，並整理閱讀器與導航的內部結構。既有書架、紀錄和設定可繼續使用，Android 可直接覆蓋安裝。完整內容見 [版本說明](docs/releases/v2.1.0.md)，發版檢查見 [驗證紀錄](docs/QA-v2.1.0.md)。
